...
const Footer = () => {
  return (
    <footer className=" bg-[#1A1A1D] max-w-6xl mx-3 rounded-[28px]  px-7 pt-9 pb-6 text-white lg:px-10 lg:pt-10">
      {/* top */}
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-[400px_1fr]">
        {/* left */}
        <div className="lg:pr-10">
          <h3 className="mb-5 text-[26px] font-semibold font-sans-primary tracking-tight">
          ...
          <div className="flex  flex-wrap gap-[6px]">
            {socials.map((Icon, index) => (
              <a
                key={index}
                href="#"
                className="flex h-[24px] items-center justify-center gap-[6px] rounded-full border border-[#2a2a2a] bg-white px-[10px] text-black transition-all duration-300 hover:opacity-80"
              >
                <Icon className="text-[11px]" />
                <HiArrowUpRight className="text-[9px]" />
              </a>
            ))}
          </div>
        </div>
  ...
  <div className="flex items-start">
    ...
    <span
      className="
        ...
        mt-[1.5vw]
        flex
        h-[clamp(20px,2.2vw,42px)]
        w-[clamp(20px,2.2vw,42px)]
        items-center
        justify-center
        rounded-full
        border-2
...
<div class="col-span-12 mt-10  | lg:mt-32">

     
    <div className="text-white">

        <svg className="w-full h-full object-contain fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 168 21" f="none">
  ...
  <path d="M165.127 10.1622C166.714 10.1622 168 8.87583 168 7.28913C168 5.70242 166.714 4.41602 165.127 4.41602C163.54 4.41602 162.254 5.70242 162.254 7.28913C162.254 8.87583 163.54 10.1622 165.127 10.1622ZM165.127 5.22763C166.264 5.22763 167.189 6.15219 167.189 7.28913C167.189 8.42606 166.264 9.35062 165.127 9.35062C163.99 9.35062 163.066 8.42606 163.066 7.28913C163.066 6.15219 163.99 5.22763 165.127 5.22763Z"></path>
      ...
      {/* bottom */}
      <div className="mt-5 flex flex-col gap-3 border-t border-[#1f1f1f] pt-5 text-[11px] font-medium tracking-[-0.01em] text-gray-200 lg:flex-row lg:items-center lg:justify-between">
