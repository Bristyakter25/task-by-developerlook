import img7 from "../../assets/images/global.png";
import img8 from "../../assets/theDrum.png";
  ...
  return (
    ...
    <div>
         <main className="relative  z-10 flex flex-col items-center justify-center pt-24 text-center px-4">
          ...
          {/* Heading */}
          <p className="uppercase text-[11px] md:text-xs font-medium tracking-wide text-center max-w-[220px] leading-tight mb-3">
            #1 Most recommended <br /> content marketing agency
          </p>
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            {/* Left laurel */}
            <svg viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-6 fill-current text-white">
            ...
            {/* <img
              src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Awards/White/UKSocial-Media-Awards-White.png"
              alt=""
              className="h-5 md:h-6 object-contain opacity-90"
            />
        
            <img
              src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Awards/White/UK-Content-Awards-White.png"
              alt=""
              className="hidden lg:block h-5 md:h-6 object-contain opacity-90"
            /> */}
                  ...
                  <h1 className="text-5xl md:text-6xl lg:text-7xl font-semibold  leading-[1.05] max-w-5xl">
                    ...
                    <span className="inline-block mx-4 align-middle">
                      <img
                        src={randomImage}
                        alt=""
                        className="w-16 h-16 md:w-20 md:h-20 rounded-2xl object-cover object-center shadow-2xl border border-white/20"
                      />
                    </span>
                    Leaders
                  </h1>
        
                  <p className="mt-6 text-lg md:text-[23px] text-white font-bold">
                    on every searchable platform
                  </p>
                </main>

                <div className="absolute -bottom-36 left-6 max-w-lg text-[15px] text-white font-semibold">
          Organic media planners creating, distributing & optimising
search-first content for SEO, Social, PR, Ai and LLM search 4 Global Offices serving
        </div>

        <div className="absolute -bottom-36  right-6 text-sm text-white font-semibold text-right">
          4 Global Offices serving <br />
          UK, USA (New York) & EU
        </div>
    </div>
